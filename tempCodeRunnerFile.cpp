...
// Fungsi untuk memvalidasi apakah kode sandi berada dalam rentang yang ditentukan
bool validasiKode(int angka) {
    return (angka > 100 && angka <= 99999);
}

// Fungsi untuk mengecek apakah angka habis dibagi 2 dan 3 tetapi tidak habis dibagi 5
